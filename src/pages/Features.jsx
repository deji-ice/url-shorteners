...
const Features = () => {
  return (
    <div className="bg-indigo-50 mt-20 font-[poppins]">
      <div className="m-8 h-[8rem] bg-indigo-600 flex items-center justify-center text-center rounded-md  
      relative bottom-14 mb-[-2rem]
      lg:w-10/12 lg:bottom-[-14rem] lg:h-[10rem] lg:left-[7rem] lg:absolute lg:m-10 lg:mt-[50rem]">
        <URLform />
      </div>
